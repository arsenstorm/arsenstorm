/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings workers.d.ts` (hash: 40009bb36c4f652c4e0dcdb90daeffd5)
// Runtime types generated with workerd@1.20260710.1 2026-04-22 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	STATS: KVNamespace;
	MARKDOWN_STATS: AnalyticsEngineDataset;
	ASSETS: Fetcher;
	GITHUB_TOKEN: string;
	APPLE_KEY_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_TOKEN" | "APPLE_KEY_ID" | "APPLE_TEAM_ID" | "APPLE_SERVICE_ID" | "APPLE_PRIVATE_KEY">> {}
}
