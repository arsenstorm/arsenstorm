/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers.d.ts --env-interface CloudflareBindings` (hash: 7e6cd267e37fbcc5c026145d6b51878d)
// Runtime types generated with workerd@1.20260421.1 2026-04-22 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OGRenderer";
	}
	interface Env {
		STATS: KVNamespace;
		OG_IMAGES: R2Bucket;
		...
		OG_RENDERER: DurableObjectNamespace<import("./src/index").OGRenderer>;
	}
}
