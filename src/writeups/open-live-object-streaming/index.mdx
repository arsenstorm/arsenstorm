...
metaDescription: "OLOS (Open Live Object Streaming): a draft protocol for low-latency live video on object storage like Cloudflare R2, with a coordinator instead of a media server."
