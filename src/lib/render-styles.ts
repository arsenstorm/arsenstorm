import type { Main, Props } from "#/lib/render";
...
export const mainStyles = (props: Props & Main) => `
		${shared}
...
export const topStyles = (props: Props & { contributions: number }) => `
		${shared}
...
export const linkStyles = (props: Props & { index: number }) => {
...
export const fallbackStyles = (props: Props & { width: number }) => `
		${shared}
